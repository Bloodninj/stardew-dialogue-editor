<script>
    ...
    $: hasFemale = (femaleDialogue != null); // bool
    $: hasNonbinary = (nonbinaryDialogue != null); // bool
    let validData; // bool
    ...
    function submitDialogue(e) {
        ...
        if (msgIndex != null) {
            ...
            showModal = false;
            maleDialogue, maleExpression, femaleDialogue, femaleExpression, nonbinaryDialogue, nonbinaryExpression = null;
            dialogue.close();
        }
...
>
    ...
    <div on:click|stopPropagation class="container">
        <form
            ...
            <div class="col-12">
                <h2 class="text-center">{getMessage("stardew-dialogue-maker-add-new-text")}</h2>
            </div>
